...
\begin{figure}[t]
	\centering
	\includegraphics[width=0.45\textwidth]{images/architecture_new}
	\vspace{-5pt}
...
\subsection{Control and Data Plane Separation}
...
\subsection{Multiplex Connections via a Queue}
...
\subsection{Multi-Process Shared Socket}
\label{subsec:fork}
