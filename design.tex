...
As shown in Figure~\ref{fig:conn-setup}, during connection creation, a \textit{server} process calls \texttt{bind} and \texttt{listen}, while a \textit{client} process calls \texttt{connect}.
...
\begin{figure}[t]
	...
	\caption{The structure of lockless queue.}
	\vspace{-15pt}
