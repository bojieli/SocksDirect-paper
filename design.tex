...
\subsection{Scaling to Millions of Connections}
\label{subsec:socket-api}
\libipc is a user-space library to achieve kernel

To remove locks for inter-thread mutual exclusion, each thread is treated as a separated process in our design.
