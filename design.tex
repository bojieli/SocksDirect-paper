...
The communication initiator first sends a request to the local monitor, then the monitor establish a shared memory queue between the two applications (possibly in different containers). Then the two applications can communicate directly.  
