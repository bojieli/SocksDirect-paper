...
For communication within a same host, we use a high performance user space shared memory queue.
...
To share a CPU core efficiently among multiple active threads without thread wakeup overhead, we use \emph{cooperative multitasking}. 
%\fi
