...
We design a secure and efficient protocol for \libipc{} to delegate connection creation to the local monitor, while implement data transmission and event polling peer-to-peer among applications.
