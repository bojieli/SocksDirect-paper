...
\begin{figure}[t]
	\centering
	\subfloat[Intra-server SHM.]{
		\includegraphics[width=0.2\textwidth]{images/zerocopy_intra}
		\label{fig:zerocopy-intra}
	}
	\hspace{0.05\textwidth}
	\subfloat[Inter-server RDMA.]{
		\includegraphics[width=0.17\textwidth]{images/zerocopy_inter}
