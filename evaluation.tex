...
\begin{figure}[htpb]
	...
	\subfloat[Intra-server latency]{
		%\begin{minipage}{0.4\textwidth}
		\centering \includegraphics[width=0.33\textwidth]{eval/microbenchmark/msgsize-ipc-lat.pdf}
...
\begin{figure}[htpb]
	...
	\subfloat[Inter-server throughput]{
		%\begin{minipage}{0.4\textwidth}
		\centering \includegraphics[width=0.33\textwidth]{eval/microbenchmark/msgsize-network-tput.pdf}
	...
	\subfloat[Inter-server latency]{
		%\begin{minipage}{0.4\textwidth}
		\centering \includegraphics[width=0.33\textwidth]{eval/microbenchmark/msgsize-network-lat.pdf}
...
\subfloat[Inter-server]{
	%\begin{minipage}{0.4\textwidth}
		\centering \includegraphics[width=0.33\textwidth]{eval/microbenchmark/connnum-network-tput.pdf}
...
\subfloat[Inter-server]{
	%\begin{minipage}{0.4\textwidth}
		\centering \includegraphics[width=0.33\textwidth]{eval/microbenchmark/corenum-network-tput.pdf}
