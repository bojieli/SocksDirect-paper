...
The data transmission performance above is linearly scalable with number of cores. In addition, a CPU core can establish 1.4~M per connections per second.
