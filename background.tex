...
\textbf{Context switch and scheduling.}
...
%\textbf{Network stack.}
%. Sockets within a same server still need to go through the network stack.
...
Table~\ref{tab:related-work} compares several representative existing approaches. %The first line of work optimizes Linux kernel socket.
