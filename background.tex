...
As Table~\ref{tab:operation-performance} shows, if we use semaphore, mutex or \texttt{futex} to wake up a sleeping thread, it is 5x$\sim$10x slower than cooperative context switch via \texttt{sched\_yield}.
