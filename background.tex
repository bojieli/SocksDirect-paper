...
\begin{table}[t]
	...
	\scalebox{0.9}{
		\begin{tabular}{l|l|l|}
			...
			\hline
			Inter-server TCP (4.16) & 9.5 & 0.3 \\
			\hline
			128~KiB memory copy & 15 & 0.07 \\
			\hline
			Create TCP socket (4.16) & 35 & 0.03 \\
			\hline
		\end{tabular}
	}
