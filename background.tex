...
As shown in Table~\ref{tab:operation-performance}, the hairpin latency from CPU to NIC is still 25x higher than inter-core cache migration delay ($\sim$30ns). The throughput is also limited by Memory-Mapped I/O doorbell latency and PCIe bandwidth~\cite{neugebauer2018understanding,li2017kv}.
