...
We multiplex connections among a pair of threads, but this cannot reduce the number of RDMA connections with a lot of hosts.
NIC still suffer from performance degradation due to large number of connections.
