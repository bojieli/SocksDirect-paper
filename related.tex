...
\sys{} multiplexes connections, but it cannot reduce the number of RDMA connections with a lot of hosts.
...
\textbf{QoS.}
\sys{} offloads data-plane performance isolation and congestion control to the RDMA NIC, following an emerging line of work~\cite{peter2016arrakis,zhu2015congestion,lu2017memory,mprdma} in this direction, because NICs in data centers are becoming increasingly programmable~\cite{smartnic,cavium,kaufmann2015flexnic,li2016clicknp}.
